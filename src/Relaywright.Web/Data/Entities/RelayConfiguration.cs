...
public sealed class RelayConfiguration
{
    ...
    public UpstreamAuthenticationMode UpstreamAuthenticationMode { get; set; } = UpstreamAuthenticationMode.Basic;

    public string? UpstreamUserName { get; set; }

    public string? ProtectedUpstreamPassword { get; set; }

    public string? MicrosoftTenantId { get; set; }

    public string? MicrosoftClientId { get; set; }

    public string? ProtectedMicrosoftClientSecret { get; set; }
